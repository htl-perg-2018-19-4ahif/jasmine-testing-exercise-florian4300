...
describe("AppComponent", () => {
      ...
      providers: [
        {
          ...
          useValue: new InvoiceCalculatorServiceMock()
        }
      ]
    }).compileComponents();
  }));
  ...
  it("should add invoice line correctly", () => {
    ...
    let invoiceLines = ne.querySelectorAll<HTMLTableRowElement>(
      "#invoice-lines"
    );
    ...
    const vatCategoryInput: HTMLSelectElement = ne.querySelector(
      "#vat-category-input"
    );
    vatCategoryInput.value = "Food";
    vatCategoryInput.dispatchEvent(new Event("input"));
    const priceInclusiveVatInput: HTMLInputElement = ne.querySelector(
      "#priceInclusiveVat-input"
    );
  ...
  it("should calculate totals correctly", () => {
    ...
    const totalPriceInclusiveVatInput: HTMLTableDataCellElement = ne.querySelector(
      "#totalPriceInclusiveVat"
    );
    expect(totalPriceInclusiveVatInput.textContent).toBe("84.00");
    const totalPriceExclusiveVatInput: HTMLTableDataCellElement = ne.querySelector(
      "#totalPriceExclusiveVat"
    );
    expect(totalPriceExclusiveVatInput.textContent).toBe("42.00");
  });
  it("should disable button when price is negative or 0", () => {
    const fixture = TestBed.createComponent(AppComponent);
    const de = fixture.debugElement;
    const ne: HTMLElement = de.nativeElement;
    const app: AppComponent = de.componentInstance;
